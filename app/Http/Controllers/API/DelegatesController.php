...
//                   $cart->save();
    ...
    public function order_history(){
        ...
        // return $app_user_id;
        $histories = DeliveryHistory::with('orderTables')->where('user_id',$app_user_id)->whereIn('status_id',[OrderController::DeliveredToLaundry,OrderController::Completed])->latest()->get();
