...
//                   $cart->save();
    ...
    public function accept_order(Request $request,$order_id){
        $app_user_id = auth('app_users_api')->user()->id;
//        $order = OrderTable::whereIn('status_id',[OrderController::WaitingForDelivery,OrderController::AcceptedByDelivery,OrderController::WaitingForDeliveryToReceiveOrder])
