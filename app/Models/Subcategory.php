...
class Subcategory extends Model
{
    ...
    protected  $guarded = [];
    protected $fillable=['category_id','name_en','name_ar','parent_id','address','city_id','location','price','status','around_clock','clock_at','clock_end','image','rate','approximate_duration'];
