...
class OrderDetails extends Model
{
    ...
    protected $guarded = [];
    protected $fillable=['order_table_id','category_id', 'product_id', 'category_item_id', 'product_service_id','carpet_category_id','price', 'quantity', 'total_price', 'commission', 'total_commission', 'full_price'];
    use SoftDeletes;
