...
{{--c                        <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{asset('assets/customers/app-assets/pages/eCommerce/1.png')}}" alt="donuts" width="62">--}}
...
{{--                    </li>--}}
{{--                    <li class="active"><a class="d-flex align-items-center" href="app-ecommerce-checkout.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Checkout">Checkout</span></a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
