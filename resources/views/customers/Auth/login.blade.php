...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/customers/app-assets/css-rtl/pages/page-auth.css')}}">
                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                            <img class="img-fluid" src="{{asset('assets/customers/app-assets/images/pages/login/logo.png')}}" alt="Login V2" />
                        </div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
