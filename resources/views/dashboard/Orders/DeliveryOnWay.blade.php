...
{{--                                        @php--}}
{{--                                            $current = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::AcceptedByDelivery)->first();--}}
{{--                                            $next = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::WayToLaundry)->first();--}}
{{--                                        @endphp--}}
{{--                                        <tr>--}}
{{--                                            <td>{{$order->id}}</td>--}}
