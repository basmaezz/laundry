...
{{--                                        <th>   العنوان </th>--}}
                                    ...
                                    @foreach($orders as $order)
                                        @php
                                            $current = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::AcceptedByDeliveryToYou)->first();
                                            $next = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::Completed)->first();
                                        @endphp
                                        <tr>
                                            <td>{{$order->id}}</td>
