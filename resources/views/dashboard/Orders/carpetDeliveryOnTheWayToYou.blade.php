                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">جدول طلبات المندوب فى الطريق للعميل
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <script type="text/javascript">
                $(function() {
                    var table = $('#orderTable').DataTable({
                        ...
                        serverSide: true,
                        ordering: false,
                        ajax: "{{ Route('Order.carpetDeliveryOnTheWayToYou') }}",
                        columns: [{
                            data: 'id',
                            name: 'id'
                        },{
                ...
                $('body').on('click', '#deleteBtn', function () {
                    ...
                    if (confirm("هل تريد اتمام الالغاء ؟") == true) {
                        ...
                        $.ajax({
                            type:"get",
                            url: "{{ route('Order.carpetDeliveryOnTheWayToYou') }}",
                            data: { id: id},
                            dataType: 'json',
