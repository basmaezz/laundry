...
{{--                                        @php--}}
{{--                                            $current = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::WayToLaundry)->first();--}}
{{--                                            $next = $order->histories->where('status_id',\App\Http\Controllers\Admin\OrderController::DeliveredToLaundry)->first();--}}
{{--                                        @endphp--}}
{{--                                        <tr>--}}
{{--                                            <td>{{$order->id}}</td>--}}
