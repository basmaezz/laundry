                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('carpetLaundryTimes.update',$carpetLaundryTime->id)}}" >
                                ...
                                <input type="hidden"  name="carpet_laundry_id" class="form-control"value="{{$carpetLaundryTime->carpetLaundry->id}}">

                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="hf-email">اسم المنطقه</label>
                                    <div class="col-md-9">
                                        <input type="text"  name="area_name" class="form-control"value="{{$carpetLaundryTime->carpetLaundry->area_name}}" disabled >
