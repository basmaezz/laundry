...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/customers/app-assets/vendors/css/forms/select/select2.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/customers/app-assets/css-rtl/plugins/forms/form-validation.css')}}">
...
<script src="{{asset('assets/customers/app-assets/vendors/js/forms/select/select2.full.min.js')}}"></script>
...
<script src="{{asset('assets/customers/app-assets/js/scripts/forms/form-validation.js')}}"></script>
...
<script type="text/javascript">
    ...
    function hideMakeUrgent(){
        ...
        let approximateDurationUrgent= document.getElementById('approximate_duration_urgent_input');
        approximateDurationUrgent.style.display ="none"
        // (approximateDurationUrgent.style.display ==="block") ? :'';
    }
